mcl_RUDAT.dll - ActiveX COM Object for programmers
...
mcl_RUDAT.dll file should be located on system folder eg: "c:\windows\system32"
...
18 Ethernet Functions - available only for RCDAT models!
	GetEthernet_CurrentConfig()
        ...
        GetEthernet_TELNETPort()   // in Firmware C7 and above
        GetEthernet_UseDHCP()
        GetEthernet_UsePWD()
        ...
        SaveEthernet_TELNETPort()   // in Firmware C7 and above
...
Dim MyAtt As New MCL_RUDAT.USB_DAT ,Status as integer
...
program Example in C#:
  ...
  mcl_RUDAT.USB_DAT MyAtt = new mcl_RUDAT.USB_DAT();
int Status = 0;
float SetAtt = 20.5f;
string Address = "";
...
MCL_RUDAT::USB_DAT ^MyAtt = gcnew MCL_RUDAT::USB_DAT();
short Status = 0;
System::String ^SN = "";
